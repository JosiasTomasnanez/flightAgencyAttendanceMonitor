 ...
 * {@link Runnable}. Este proceso dispara las transiciones T0 y T1 de la red de
 * Petri de manera
 * secuencial en cada ciclo, hasta que el monitor indique que el proceso ha
...
public class EntradaDeClientes implements Runnable {
  ...
  /**
   * Metodo que ejecuta el proceso de entrada de clientes a la agencia, disparando
   * las transiciones
   ...
   * ciclo, el metodo
   * dispara las transiciones T0 (entrada del cliente) y T1 (proceso posterior) de
   * manera
   * secuencial, con un período de espera para simular la duración del proceso de
   * entrada del
   * cliente.
   *
  ...
  /**
   * Representación en cadena de texto del proceso de entrada de clientes a la
   * agencia.
   *
