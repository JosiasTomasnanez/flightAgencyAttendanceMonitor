/**
 * La clase {@code AlfaException} es una excepción personalizada que se lanza cuando
 * el tiempo transcurrido no cumple con el límite mínimo establecido ({@code alfa}).
 * Esta excepción se utiliza en el contexto de la clase {@code AlfaYBeta}
 * para indicar que el tiempo registrado es inferior al valor mínimo permitido.</p>
 */
